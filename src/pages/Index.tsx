...
const Index = () => {
  ...
  const AnimatedIcon = ({ icon: Icon, className, delay = 0 }: { icon: any; className?: string; delay?: number }) => (
    <div className={`inline-flex p-3 rounded-full ${className} animate-float`} style={{ animationDelay: `${delay}s` }}>
        ...
        <main className="container py-12">
          ...
          <div className="text-center space-y-8 mb-12">
            <div className="flex justify-center items-center gap-6 mb-8">
              <AnimatedIcon icon={ShoppingCart} className="bg-blue-100 text-blue-600" delay={0} />
              <AnimatedIcon icon={Package} className="bg-green-100 text-green-600" delay={0.5} />
              <AnimatedIcon icon={Box} className="bg-orange-100 text-orange-600" delay={1} />
              <AnimatedIcon icon={Truck} className="bg-purple-100 text-purple-600" delay={1.5} />
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-12 animate-fade-in" style={{ animationDelay: '0.6s' }}>
              <div className="text-center group">
                <div className="bg-blue-100 text-blue-600 rounded-full p-4 inline-flex mb-3 group-hover:scale-110 transition-transform">
              ...
              <div className="text-center group">
                <div className="bg-green-100 text-green-600 rounded-full p-4 inline-flex mb-3 group-hover:scale-110 transition-transform">
              ...
              <div className="text-center group">
                <div className="bg-orange-100 text-orange-600 rounded-full p-4 inline-flex mb-3 group-hover:scale-110 transition-transform">
              ...
              <div className="text-center group">
                <div className="bg-purple-100 text-purple-600 rounded-full p-4 inline-flex mb-3 group-hover:scale-110 transition-transform">
