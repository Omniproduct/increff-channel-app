...
export const PartnerLocationForm = () => {
  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-4 gap-8">
      {/* Left Column - Partner Selection & Settings */}
      <div className="xl:col-span-1">
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="bg-slate-50/50 rounded-lg p-6">
            <h3 className="text-lg font-semibold mb-4 text-foreground">Partner Selection</h3>
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <RadioGroup value={partnerType} onValueChange={setPartnerType} className="flex flex-col gap-3">
          ...
          <div className="bg-slate-50/50 rounded-lg p-6">
            <h3 className="text-lg font-semibold mb-4 text-foreground">Additional Settings</h3>
            <div className="space-y-4">
              <div className="space-y-2">
              ...
              <div className="space-y-3">
                ...
                <RadioGroup value={excessGrnAllowed} onValueChange={setExcessGrnAllowed} className="flex flex-col gap-3">
                  <div className="flex items-center space-x-2">
      ...
      <div className="xl:col-span-3">
        <Collapsible open={addressExpanded} onOpenChange={setAddressExpanded}>
          <CollapsibleTrigger className="flex items-center justify-between w-full p-4 bg-slate-50 rounded-lg hover:bg-slate-100 transition-colors">
            <h3 className="text-lg font-semibold">Location Address Information</h3>
            <ChevronDown className={cn("h-5 w-5 transition-transform", addressExpanded && "rotate-180")} />
          </CollapsibleTrigger>
          <CollapsibleContent className="mt-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4 p-6 border rounded-lg bg-white">
              <div className="space-y-2">
